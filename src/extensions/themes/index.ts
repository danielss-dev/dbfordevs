 ...
 * Themes are isolated - they inject their CSS when enabled and remove it when disabled.
 */
...
export function useThemes() {
  ...
  return {
    activeThemeId,
    themes: getAllThemes(),
    officialThemes: getAllThemes().filter((t) => t.isOfficial),
    communityThemes: getAllThemes().filter((t) => !t.isOfficial),
...
// ============================================================================
// Initialize on module load - restore persisted theme
// ============================================================================
