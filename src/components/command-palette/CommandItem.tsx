...
export function CommandItem({ command, onSelect, valuePrefix }: CommandItemProps) {
  ...
  return (
    <Command.Item
      ...
      className="group flex items-center gap-3 rounded-md px-3 py-[var(--pad-list-y)] text-sm cursor-pointer select-none aria-selected:bg-accent aria-selected:text-accent-foreground data-[disabled]:pointer-events-none data-[disabled]:opacity-50"
    >
      {Icon && (
