...
function FieldEditor({ name, value, type, nullable, isPrimaryKey, isAutoIncrement, isCreatingNew, onChange }: FieldEditorProps) {
  ...
  // - In edit mode: null fields and primary keys are disabled (use NULL toggle to enable)
  const isFieldDisabled = isCreatingNew
    ? (isAutoIncrement ?? false) // Only disable auto-increment in create mode
    : (isNull || (isPrimaryKey ?? false)); // In edit mode, disable null and PK
      ...
      return (
        <Input
          ...
          className={cn(
            ...
            isFieldDisabled ? "bg-muted/50 text-muted-foreground italic opacity-70 cursor-not-allowed" : "bg-background/50 focus:bg-background"
          )}
          placeholder={isFieldDisabled ? (showAutoGenerated ? "Auto-generated" : "NULL") : `Enter ${name}`}
        />
      );
    }
          ...
          <div className="flex-1 space-y-2">
            ...
            <Textarea
              ...
              className={cn(
                ...
                isFieldDisabled ? "bg-muted/50 text-muted-foreground italic" : "bg-background/50 focus:bg-background"
              )}
              placeholder={isFieldDisabled ? "NULL" : `Enter ${name}`}
            />
          </div>
      ...
      return (
        <div className="flex items-center gap-2 flex-1">
          <Input
            ...
            placeholder={isFieldDisabled ? "NULL" : "xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx"}
          />
          <Tooltip>
            <TooltipTrigger asChild>
              <Button
      ...
      <div className="flex items-center justify-between gap-2">
        <div className="flex items-center gap-2">
          ...
          {isAutoIncrement && isCreatingNew && (
            <Badge variant="outline" className="text-[9px] px-1.5 py-0 h-4 bg-blue-500/10 text-blue-600 dark:text-blue-400 border-blue-500/30">
              Auto
            </Badge>
          )}
        </div>
